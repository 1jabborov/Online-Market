    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('created', 'созданный'), ('accepted', 'потверждённый'), ('completed', 'завершённый'), ('canceled', 'отклонённый')], default='created', max_length=255, verbose_name='Status')),
