...
class Manufactory(models.Model):
    ...
    class Meta:
        verbose_name = 'Manufactured by the factory'
...
class Product(models.Model):
    ...
    manufactory = models.ForeignKey('Manufactory', on_delete=models.PROTECT, related_name='manufactory_re', verbose_name='Developed Enterprise', null=True)  # verbose_name
    country = models.ForeignKey('Country', on_delete=models.PROTECT, verbose_name='Country of origin', null=True, blank=True)
    sale_count = models.IntegerField(default=0, verbose_name='Number of sales')
...
class ProductMedia(models.Model):
    ...
    class Meta:
        verbose_name_plural = 'Product Videos/Pictures'
